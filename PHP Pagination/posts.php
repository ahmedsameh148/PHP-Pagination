...
require_once(BASE_PATH . '/logic/url.php');
...
$page_size = 2;
$postsCount = getPostsCount($page_size, $page, $category_id, $tag_id, null, $q);
$posts = getPosts($page_size, $page, $category_id, $tag_id, null, $q);
$pagesNumber = ceil($postsCount / $page_size);
        ...
        <div class = "row">
            ...
            <div class = "col-lg-10">
                ...
                <a href="<?php 
                            ...
                            if($newPage == 0)
                                $newPage++;
                            $TO = BuildURL($newPage, $category_id, $tag_id, null, $q, $_SERVER['PHP_SELF']);
                            echo $TO;
                        ?>">&laquo;</a>
                    <?php
                        
                        for($i = 1; $i <= $pagesNumber; $i++){
                            $TO = BuildURL($i, $category_id, $tag_id, null, $q, $_SERVER['PHP_SELF']);
                            if($i == $page)
                                echo "<a class='active' href=$TO> $i </a>";
                            else 
                                echo "<a href = $TO > $i </a>";
                        }
